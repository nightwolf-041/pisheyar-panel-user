...
class ClientChat extends Component {
    ...
    componentDidMount() {
            ...
            try {
              await connection.start().then(() => {
                connection.on('ReceiveMessage', function (clientName, text, sendAt) {
                    ...
                    // chatMessages.push({text, sendAt})
                    this.setState({sendedChatMessages: {text, sendAt}}, () => console.log(this.state.sendedChatMessages);)
                })
              })
        ...
        //     try {
        //         connection.on('RecieveMessage', (clientName, text, sendAt) => {
