    ...
    return (
        ...
        style={!props.hamburgerMenuToggle ? {right: '-500px'} : {right: 0}}>
            ...
            />
                ...
                showProfileSetting={props.showProfileSetting}
            ...
            <>
                ...
                <ClientChatSudebarAccordion 
                    ...
                    showPesronMessageModal={(reqGuid, message, contractor, price, isAllowed, gender) => props.showPesronMessageModal(reqGuid, contractorGuid, message, contractor, price, isAllowed, gender)}
