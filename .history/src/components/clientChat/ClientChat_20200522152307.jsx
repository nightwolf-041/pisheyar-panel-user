        ...
        return (
            ...
            <div className="chatbox-sidebar" ref={this.chatSidebar}>
                ...
                <>
                 ...
                 <div className={!this.state.collapsibleOpen ? 
                    ...
                    <div className="collapsible-trigger-division-rightbox">
                     ...
                     <div className="collapsible-trigger-division-leftbox">
                         ...
                         <FontAwesomeIcon
                         icon={!this.state.collapsibleOpen ? 
                 ...
                 onOpen={() => this.setState({collapsibleOpen: !this.state.collapsibleOpen})}
                 onClose={() => this.setState({collapsibleOpen: !this.state.collapsibleOpen})}
                 easing="ease-in"
