...
import { faBars, faTimes, faSearch, faDownload, faPaperclip, faArrowLeft, faAngleDown } from '@fortawesome/free-solid-svg-icons'
        ...
        return (
            ...
            <div className="chatbox-sidebar" ref={this.chatSidebar}>
                ...
                <>
                 <Collapsible
                 trigger={
                 <div className={!this.state.collapsibleOpen ? 
                    ...
                    <div className="collapsible-trigger-division-rightbox">
                     ...
                     <div className="collapsible-trigger-division-leftbox">
                         ...
                         <FontAwesomeIcon icon={faAngleDown}className="collapsible-trigger-division-badge-icon" />
                     </div>
                 </div>
                 }
                ...
                <div className="chatbox-main-content">
                    ...
                    <div className="chatbox-main-content-sended-image-right">
                        ...
                        <div className="chatbox-main-content-sended-image-right-profbox">
                            <img src={amooLogo} alt="" className="chatbox-main-content-sended-image-right-profile" />
                        </div>
                    </div>
                    ...
                    <div className="chatbox-main-content-sended-image-left">
                        ...
                        <div className="chatbox-main-content-sended-image-left-profbox">
                            <img src={rubyLogo} alt="" className="chatbox-main-content-sended-image-left-profile" />
                        </div>
                    </div>
                    ...
                    <div className="chatbox-main-content-sended-file-left">
                        ...
                        <div className="chatbox-main-content-sended-file-left-profbox">
                            <img src={rubyLogo} alt="" className="chatbox-main-content-sended-file-left-profile" />
                        </div>
                    </div>
                    ...
                    <div className="chatbox-main-content-sended-file-right">
                        ...
                        <div className="chatbox-main-content-sended-file-right-profbox">
                            <img src={amooLogo} alt="" className="chatbox-main-content-sended-file-right-profile" />
                        </div>
                    </div>
