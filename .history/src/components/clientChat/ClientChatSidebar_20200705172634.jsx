                ...
                <Accordion allowMultipleExpanded={false}>
                    ...
                    {clientOrders.map((orderReq, index) => (
                        ...
                        <AccordionItemPanel>
                            ...
                            <ClientSubOrders
                            guid={clickedOrderGuid} miaLogo={props.miaLogo}
                            showPesronMessageModal={(reqGuid, message, contractor, price, isAllowed) => props.showPesronMessageModal(reqGuid, message, contractor, price, isAllowed)} />
