...
import maleAvatar from '../../assets/images/johnny-sins.jpg'
import femaleAvatar from '../../assets/images/johnny-sins.jpg'
import amooLogo from '../../assets/images/johnny-sins.jpg'
...
class ClientChat extends Component {
  ...
  showPesronMessageModal = (reqGuid, message, contractor, price, isAllowed) => {
    const connection = this.state.connection
    const { cookies } = this.props
    const token = cookies.get('token')
    ...
    .then(res => {
      ...
      this.setState({
       ...
       if(res.data.allowingStatus === true) {
            ...
            axios.get('http://185.94.97.164/api/OrderRequest/GetFinishingStatus',
            {
            ...
            axios.get(`http://185.94.97.164/api/OrderRequest/GetAcceptanceStatus?orderRequestGuid=${reqGuid}`, {
              headers: { Authorization: 'Bearer ' + token }
            }).then(res => {
              console.log(res.data);
  ...
  startChatHandler = contractor => {
    ...
    axios
      ...
      .then(res => {
        ...
        axios.get(`http://185.94.97.164/api/OrderRequest/GetAcceptanceStatus?orderRequestGuid=${guid}`, {
          headers: { Authorization: 'Bearer ' + token }
        }).then(res => {
          this.setState({acceptModalAccepted: res.data.acceptanceStatus})
        })
      ...
      <>
        ...
        <div className='chatboxkeeper'>
          <ClientChatSidebar
            ...
            showPesronMessageModal={(reqGuid, message, contractor, price, isAllowed) =>
              this.showPesronMessageModal(reqGuid, message, contractor, price, isAllowed)
            }
          />
