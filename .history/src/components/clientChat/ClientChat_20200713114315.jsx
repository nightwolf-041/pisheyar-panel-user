...
class ClientChat extends Component {
  ...
  showPesronMessageModal = (reqGuid, message, contractor, price, isAllowed, gender) => {
    ...
    axios.get(`http://185.211.59.237/api/OrderRequest/GetAllowingStatus?orderRequestGuid=${reqGuid}`,
    {
      headers: {
    ...
    .then(res => {
      ...
      this.setState({
       ...
       if(res.data.allowingStatus === true) {
            ...
            axios.get('http://185.211.59.237/api/OrderRequest/GetFinishingStatus',
            {
            ...
            axios.get(`http://185.211.59.237/api/OrderRequest/GetAcceptanceStatus?orderRequestGuid=${reqGuid}`, {
              headers: { Authorization: 'Bearer ' + token }
            }).then(res => {
              console.log(res.data);
            ...
            axios.get(
            `http://185.211.59.237/api/OrderRequest/GetChatMessages?orderRequestGuid=${reqGuid}`,
            {
                headers: {
                Authorization: 'Bearer ' + token
                }
  ...
  acceptOrderHandler = () => {
    ...
    axios.post('http://185.211.59.237/api/OrderRequest/Accept', {
  ...
  startChatHandler = contractor => {
    ...
    axios
      .post(
        'http://185.211.59.237/api/OrderRequest/AllowContractorToChatByClient',
        {
      ...
      .then(res => {
        ...
        axios.get(`http://185.211.59.237/api/OrderRequest/GetAcceptanceStatus?orderRequestGuid=${guid}`, {
          headers: { Authorization: 'Bearer ' + token }
        }).then(res => {
          this.setState({acceptModalAccepted: res.data.acceptanceStatus})
        })
        ...
        axios
          .get(
            `http://185.211.59.237/api/OrderRequest/GetChatMessages?orderRequestGuid=${guid}`,
            {
              headers: {
                Authorization: 'Bearer ' + token
              }
