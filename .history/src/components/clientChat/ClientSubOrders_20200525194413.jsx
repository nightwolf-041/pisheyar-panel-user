...
function ClientSubOrders(props) {
    ...
    let [subOrderRequestsForClient, setSubOrderRequestsForClient] = React.useState([{guid: ''}])

    React.useEffect(() => {
        if(props.guid && subOrderRequestsForClient === [{guid: ''}]) {
