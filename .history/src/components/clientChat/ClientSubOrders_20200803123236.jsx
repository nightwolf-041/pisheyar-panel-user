...
function ClientSubOrders(props) {
    ...
    React.useEffect(() => {
        ...
        if(props.guid !== null && props.guid !== undefined){
            ...
            headers: { Authorization: "Bearer " + cookies.token }
                ...
                if(res.data.state === 1){
                    ...
                    setSubOrderIsAllowed(res.data.isAllowed)
                    setSubOrderRequestsForClient(null)
                }
            }).catch(err => {

            })
        }
    }, [props.guid, props.refresh])
    ...
    return (
        <>
        {!requestLoading ?
            subOrderRequestsForClient !== null ?
