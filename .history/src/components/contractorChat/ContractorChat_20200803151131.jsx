...
class ClientChat extends Component {
  ...
  showPaymentModalModal = () => {
    this.setState({
      paymentModalHidden: false
    })
  }
  hidePaymentModalModal = () => {
    this.setState({
      paymentModalHidden: true
    })
  }
  ...
  showOrdersPage = (guid) => {
    ...
    this.setState({ordersPageLoading: true})
    ...
    axios.get(`http://185.211.59.237/Order/GetOrdersForContractor?categoryGuid=${guid}`, {
      ...
      this.setState({ordersPageLoading: false})
    ...
    this.setState({prevClickedOrderGuid: this.state.clickedOrderGuid}, () => {
      ...
      axios
        ...
        .then(res => {
          ...
          this.setState({contractorChatMainLoading: false})
  ...
  render () {
    return (
      <>
        ...
        <PaymentModal
         hidden={this.state.paymentModalHidden}
         hidePaymentModalModal={this.hidePaymentModalModal}
        />
        ...
        <div className='chatboxkeeper'>
          <ContractorChatSidebar
            ...
            setCurrentTabRight={this.setCurrentTabRight}
