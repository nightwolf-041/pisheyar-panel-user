    ...
    return (
        ...
        >
            ...
            <div className={classes.clientFinishModalRatingBox}>
                <Rating 
                emptySymbol={<FontAwesomeIcon icon={faStar} style={{color: '#ffd41746', fontSize: '1.4rem', margin: '0 0.2rem'}} /> }
                fullSymbol={<FontAwesomeIcon icon={faStar} style={{color: '#ffd617', fontSize: '1.5rem', margin: '0 0.2rem'}} /> }
