...
const ContractAcceptModal = (props) => {
    ...
    const orderRequestCreate = () => {
        ...
        if(contractorTitleInput.length > 2 && onluNum.test(contractorOfferedPrice) && contractorMessage.length > 5 && contractorOfferedPrice.length >= 4) {
        ...
        }else if(!onluNum.test(contractorOfferedPrice) && contractorTitleInput.length > 2) {
