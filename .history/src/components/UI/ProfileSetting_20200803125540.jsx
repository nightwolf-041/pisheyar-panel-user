...
const ProfileSetting = (props) => {
    ...
    const [genreLoading, setGenreLoading] = React.useState(true)
    ...
    const updateProfile = () => {
        let data = {
            ...
            lastName: string,
            email: string,
            cityGuid: 3fa85f64-5717-4562-b3fc-2c963f66afa6,
            genderGuid: 3fa85f64-5717-4562-b3fc-2c963f66afa6,
            profileDocumentGuid: 3fa85f64-5717-4562-b3fc-2c963f66afa6
        }
    }
    ...
    return (
        ...
        <PerfectScrollbar>
            ...
            <Select key={2}
                menuContainerStyle={{zIndex: 50}}
                menuPortalTarget={document.body}
                inputId="profileSettingGenre11"
                instanceId="profileSettingGenre12"
                placeholder="جنسیت"
                className={classes.profileSettingSelect}
                defaultValue={prevGenre}
                label="Single select"
                isRtl={true}
            ...
            <Select key={22}
                menuContainerStyle={{zIndex: 50}}
                menuPortalTarget={document.body}
                inputId="profileSettingGenre133"
                instanceId="profileSettingGenre133"
                placeholder="جنسیت"
                className={classes.profileSettingSelect}
                label="Single selectttttt"
                isRtl={true}
                ...
                options={genres}
                getOptionLabel={option => `${option.title}`}
                getOptionValue={option => `${option.genreGuid}`}
                onChange={val => handleGenreChange(val)}
            />
            }
