...
class LoginPage extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            submitBoxSwitcherDisabled: false,
            loginBoxSwitcherDisabled: false,
            ...
            countryValue: {value: 'تهران', label: 'تهران', provinceGuid: '4060c766-3795-4b08-8f25-e99261d2cb73'},
            cityValue: {value: 'تهران', label: 'تهران', cityGuid: '0374d07e-479d-4841-b245-dd46bd5682e5'},
            genderValue: {value: '6e48b657-2c83-4481-a9c5-009ffe10158b', label: 'مرد'},

            toggleSubmitByer: false,
            logPhoneNumberErrorMsg: ''
    ...
    handleByerSubmit= () => {
        ...
        if (!this.state.loginPhoneNumberValue) {
            this.setState({
                logPhoneNumberErrorMsg: 'الزامیست',
                loginPhoneNumberValid: false
            });
        } else if (
            !/^\d+$/.test(this.state.loginPhoneNumberValue)) {
            this.setState({
                logPhoneNumberErrorMsg: 'شماره موبایل معتبر نیست',
                loginPhoneNumberValid: false
            });
        } else if(this.state.loginPhoneNumberValue.length !== 11) {
            this.setState({logPhoneNumberErrorMsg: 'شماره موبایل صحیح نیست'});
        } else {
    ...
    handleSellerSubmit= () => {
        ...
        axios.post('http://185.94.97.164/api/Account/Login', {
            mobile: this.state.loginPhoneNumberValue,
            roleGuid: '959b10a3-b8ed-4a9d-bdf3-17ec9b2ceb15'
        }).then(res => {
    ...
    componentWillUpdate() {
        ...
        if(this.state.loginRegisterSwitch === true) {
            this.setState({logPhoneNumberErrorMsg: ''})
        }
    }

    componentDidUpdate() {
        this.submitBoxSwitcher = () => {
            this.setState({ loginRegisterSwitch: true, submitBoxSwitcherDisabled: true, loginBoxSwitcherDisabled: false })
        }
        this.loginBoxSwitcher = () => {
            this.setState({ loginRegisterSwitch: false, loginBoxSwitcherDisabled: true, submitBoxSwitcherDisabled: false  })
        }

        this.registerSubmitValidate = () => {
            let errors = {};
                ...
                <div className={classes.loginPageMain}>
                    <div className={classes.loginRegisterSwitch}>
                        ...
                        <div className={
                            ...
                            disabled={this.state.submitBoxSwitcherDisabled}
                                onClick={this.submitBoxSwitcher}>
                                ثبت نام
                        </button>
                        </div>
                        ...
                        <div className={
                            ...
                            <button className={classes.loginboxButton}
                                disabled={this.state.loginBoxSwitcherDisabled}
                                onClick={this.loginBoxSwitcher}>
                                ورود
                        </button>
                        </div>
                        ...
                        <div className={
                            ...
                            {this.state.loginRegisterSwitch === false ?
                                ...
                                //         if(this.state.toggleSubmitByer === true){
                                //             console.log('yes yes yes')
                                //         }
                                //         if(this.state.toggleSubmitByer === false){
                                ...
                                //  </>logPhoneNumberErrorMsg
// loginPhoneNumberValid
                                <form className={classes.loginRegisterLoginForm}>
                                    <input
                                        className={!this.state.logPhoneNumberErrorMsg ?
                                            classes.loginRegisterLoginPhoneNumber
                                            : classes.loginRegisterLoginPhoneNumberInvalid}
                                        type="text"
                                        name="mobile"
                                        ...
                                        placeholder="شماره موبایل"
                                    />
                                    {this.state.logPhoneNumberErrorMsg && (
                                            <div className={classes.loginMobileErrorSpan}>{this.state.logPhoneNumberErrorMsg}</div>
                                        )
                                    }
                                {/* this.state.registerStatus.loading */}
                                    <button type="button"
