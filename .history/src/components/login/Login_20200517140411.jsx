                                        ...
                                        {({
                                            ...
                                            (
                                                <form className={classes.loginRegisterRegisterForm}
                                                    ...
                                                    <input
                                                        className={this.state.registerNamerValid ?
                                                        ...
                                                        placeholder="نام"
                                                    />
                                                    {!this.state.registerNamerValid && (
                                                        <div className={classes.registerNameErrorSpan}>{errors.name}</div>
                                                    )}

                                                    <input
                                                        className={this.state.registerFamilyValid  ?
                                                    ...
                                                    />
                                                    {!this.state.registerFamilyValid && (
                                                    ...
                                                    {/* <div class="form-group">
                                                        ...
                                                        defaultValue={{value: 'تهران', label: 'تهران'}}
                                                        label="Single select"
                                                    ...
                                                    <input
                                                        className={this.state.registerPhoneNumberValid ?
                                                    ...
                                                    {!this.state.registerPhoneNumberValid && (
