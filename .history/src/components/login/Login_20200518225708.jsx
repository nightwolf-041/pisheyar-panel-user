...
class LoginPage extends Component {
    ...
    registerStep1ClickHandler = () => {
        ...
        if(this.state.registerNameValue.length > 3 && this.state.registerFamlyValue.length > 3 && this.state.registerPhoneNumberValue.length === 11 &&  /^\d+$/.test(this.state.registerPhoneNumberValue) ) {
                            ...
                            {this.state.loginRegisterSwitch === false ?
                                ...
                                <div>
                                    ...
                                    <div className={classes.loginRegisterRegisterForm}>
                                        ...
                                        {this.state.registerCityValidMsg && (
                                            <div className={classes.registerCityErrorSpan}>{this.state.registerCityValidMsg}</div>
                                        )}
