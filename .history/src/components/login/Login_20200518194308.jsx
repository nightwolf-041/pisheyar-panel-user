...
class LoginPage extends Component {
    ...
    registerStep1ClickHandler = () => {
        ...
        if(this.state.registerNameValue.length > 3 && this.state.registerFamlyValue.length > 3 && this.state.registerPhoneNumberValue.length === 1 &&  /^\d+$/.test(this.state.registerPhoneNumberValue) ) {
