                            ...
                            {this.state.loginRegisterSwitch === false ?
                                <div>
                                    ...
                                    <div className={classes.loginRegisterLoginForm}
                                        onSubmit={handleSubmit}>
                                        <input
                                            className={!this.state.loginStep2CodeValidMsg ?
                                                classes.registerStep2CodeInput
                                                : classes.registerStep2CodeInputInvalid}
                                            type="text"
                                            name="loginCode"
                                            ...
                                            placeholder="کد دریافتی"
                                        />
                                        {this.state.loginStep2CodeValidMsg &&
                                            touched.logPhoneNumber && (
                                                <div className={classes.registerStep2CodeErrorSpan}>{this.state.loginStep2CodeValidMsg}</div>
                                            )
                                        }
