...
class LoginPage extends Component {
    ...
    registerCodeInputChangeHandler = (e) => {
        this.setState({registerCodeInputValue: e.target.value})
    }
                        ...
                        <div className={
                            ...
                            {this.state.loginRegisterSwitch === false ?
                                <div>
                                    ...
                                    <div className={classes.loginRegisterLoginForm}>
                                        ...
                                        <ReactCodeInput type='number' fields={6} onChange={e => this.registerCodeInputChangeHandler(e)} />
                            ...
                            {/* this.state.registerStatus.loading */}
                                ...
                                <div>
                                    ...
                                    <form className={classes.loginRegisterLoginForm}>
                                        <input
                                            className={!this.state.logPhoneNumberValidMsg ?
                                                classes.registerStep2CodeInput
                                                : classes.registerStep2CodeInputInvalid}
                                            type="text"
                                            name="code"
                                            ...
                                            placeholder="کد دریافتی"
                                        />
                                        {this.state.logPhoneNumberValidMsg &&
                                            touched.logPhoneNumber && (
                                                <div className={classes.registerStep2CodeErrorSpan}>{this.state.logPhoneNumberValidMsg}</div>
                                            )
                                        }
