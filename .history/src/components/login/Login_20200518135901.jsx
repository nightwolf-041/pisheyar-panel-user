...
class LoginPage extends Component {
    ...
    handleSellerSubmit = (val) => {
        if (!this.state.loginPhoneNumberValue) {
            ...
            this.setState({ loginPhoneNumberValid: true, loginPhoneNumberValidMsg: 'شماره موبایل صحیح نیست' })
        }
    }
                        ...
                        <div className={
                            ...
                            {this.state.loginRegisterSwitch === false ?
                                ...
                                <div className={classes.loginRegisterLoginForm}>
                                    <input
                                    className={this.state.loginPhoneNumberValidMsg === null ?
                                        classes.loginRegisterLoginPhoneNumber
                                        : classes.loginRegisterLoginPhoneNumberInvalid}
                                    type="text"
                                    name="mobile"
                            ...
                            {/* this.state.registerStatus.loading */}
                                <button type="button"
                                    onClick={() => this.handleSellerSubmit('959b10a3-b8ed-4a9d-bdf3-17ec9b2ceb15')}
                                    disabled={this.state.loginStatus.loading}
                                    className={classes.loginRegisterLoginButton}>
                                    {this.state.loginStatus.loading ?
                                    'صبور باشید' :
                                ...
                                <button type="button"
                                    onClick={() => this.handleByerSubmit('91b3cdab-39c1-40fb-b077-a2d6e611f50a')}
                                    disabled={this.state.loginStatus.loading}
                                    className={classes.loginRegisterLoginButtonByer}>
                                    {this.state.loginStatus.loading ?
                                    'صبور باشید' :
