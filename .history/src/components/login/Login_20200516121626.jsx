                                            ...
                                            (
                                                <form className={classes.loginRegisterRegisterForm}
                                                    ...
                                                    {/* <div class="form-group">
                                                        ...
                                                        <select className={["form-control", classes.loginRegisterRegisterCountry].join(' ')} id="countrySelect" onChange={(e) => console.log(e.target.value)}>
                                                            <option>تهران</option>
                                                            <option className={classes.bools}>آذربایجان شرقی</option>
                                                            <option>بوشهر</option>
                                                        ...
                                                        <select className={["form-control", classes.loginRegisterRegisterCity].join(' ')} id="citySelect">
