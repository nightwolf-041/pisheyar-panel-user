...
class LoginPage extends Component {
    ...
    componentDidMount() {
        // countries
        axios.get('http://api.pisheplus.com/Account/Provinces').then(res => {
        ...
        // axios.get(`http://api.pisheplus.com/Account/Provinces/${guid}/Cities`).then(res => {
    ...
    registerStep2ClickHandler = () => {
        ...
        axios.post('http://api.pisheplus.com/Account/Authenticate', {
    ...
    handleSellerByerSubmit = (val) => {
        ...
        axios.post('http://api.pisheplus.com/Account/Login', {
