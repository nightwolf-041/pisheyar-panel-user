...
class LoginPage extends Component {
    ...
    componentDidMount() {
        // countries
        axios.get('http://185.211.59.237/api/Account/Provinces').then(res => {
        ...
        // axios.get(`http://185.211.59.237/api/Account/Provinces/${guid}/Cities`).then(res => {
    ...
    registerStep2ClickHandler = () => {
        ...
        axios.post('http://185.211.59.237/api/Account/Authenticate', {
    ...
    handleSellerByerSubmit = (val) => {
        ...
        axios.post('http://185.211.59.237/api/Account/Login', {
